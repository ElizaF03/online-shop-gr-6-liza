<form class='login-form' action="post_registrate.php" method="post">
    ...
    <div class="flex-row">
        <input id="username" class='lf--input' placeholder='Your username' type='text' name="username">
    </div>
    <div class="flex-row">
        <input id="email" class='lf--input' placeholder='Your email' type='text' name="email">
    </div>
    <div class="flex-row">
        <input id="password" class='lf--input' placeholder='Your password' type='password' name="password">
    </div>
...
//$pdo->exec('CREATE TABLE test04 (name varchar(255) not null, age integer)');
